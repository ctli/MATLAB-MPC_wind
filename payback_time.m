...
% w/o battery
total_cost = overnight_wind*1000*800;
% annual_revenue = full_potential*0.201*energy_price; % michigan
annual_revenue = full_potential*0.36*energy_price; % Denmark
payback_period_no_battery = total_cost/abs(annual_revenue)

% w/ Lithium battery
total_cost = overnight_wind*1000*800 + overnight_battery*1000*800*0.75;
