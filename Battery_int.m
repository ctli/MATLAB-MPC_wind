...
% [ohm], whole battery pack!! not single module
...
% [volt], whole battery pack!! not single module
...
ess_max_pwr_dis = ess_voc.^2./(4*ess_r_dis); % 110~105kW in 40-70 percent SOC window
ess_max_pwr_chg = ess_voc.^2./(4*ess_r_chg); % 105~100kW in 40-70 percent SOC window
