...
save('ConvReserve', 'DTE_scheduling', 'rw_range', 'rw_dispatched');

%% ==============================
hr = 1:length(fcst);
figure(1); clf;
plot(hr, fcst, '-', 'color', [0.75 0.75 0.75]); hold on;
plot(hr, obs, '--', 'color', [0.1 0.1 0.1]);
plot(hr, DTE_scheduling, 'color', 'k', 'linewidth', 2);
...
save('ConvReserve_RampRate', 'DTE_scheduling', 'rw_range', 'rw_dispatched', 'c4', 'u0');
